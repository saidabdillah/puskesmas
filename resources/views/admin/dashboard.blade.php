                                ...
                                <div class="p-3 border border-dashed rounded-3 mb-3">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="img-group lh-0 ms-3 justify-content-start d-none d-sm-flex">
                                            ...
                                            <a href="javascript:void(0)" class="avatar-image avatar-md" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Marianne Audrey">
                                                <img src="{{ asset('assets/images/avatar/5.png') }}" class="img-fluid" alt="image" />
                                            </a>
                                            <a href="javascript:void(0)" class="avatar-image avatar-md" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Marianne Audrey">
                                                <img src="{{ asset('assets/images/avatar/6.png') }}" class="img-fluid" alt="image" />
                                            </a>
                                ...
                                <div class="mb-3">
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('assets/images/brand/app-store.png') }}" alt="laravel-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('assets/images/brand/figma.png') }}" alt="figma-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('assets/images/brand/facebook.png') }}" alt="vue-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('assets/images/brand/github.png') }}" alt="react-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('assets/images/brand/paypal.png') }}" alt="sketch-logo" class="me-3" width="35" />
                                            <div>
